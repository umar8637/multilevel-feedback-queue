    ...
    for(h = 0; h < L; h++)
    {
        ...
        for(i=0;i<N;i++){
          if(Queue1[h][i].AT<=time){
              if(Queue1[h][i].RT<=tQueue1){
                   ...
                   printf("\n%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t",Queue1[h][i].id,Queue1[h][i].BT,Queue1[h][i].WT,Queue1[h][i].TAT,Queue1[h][i].AT);
        ...
        for(i=0;i<k;i++){
            if(Queue2[h][i].RT<=tQueue2){
               ...
               printf("\n%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t",Queue2[h][i].id,Queue2[h][i].BT,Queue2[h][i].WT,Queue2[h][i].TAT,Queue1[h][i].AT);
        ...
        for(i=0;i<r;i++){
                ...
                printf("\n%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t",Queue3[h][i].id,Queue3[h][i].BT,Queue3[h][i].WT,Queue3[h][i].TAT,Queue1[h][i].AT);
